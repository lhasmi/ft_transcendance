#before that run following steps
...
# 		python3 settings.py migrate
############################################
#### In Total today : 13.03.2024
############################################
# I've installed Django and connected it to a MariaDB database.
# I've run migrations, indicating your Django project is configured correctly to communicate with  database.

############################################
# NEXT: 
############################################

#For development, I can use Django's built-in server. For production, consider learning about deploying Django with Apache and mod_wsgi.
