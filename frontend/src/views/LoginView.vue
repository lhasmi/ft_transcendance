...
<template>
  ...
  >
    <div
      class="col-8 col-md-5 col-xl-3 bg-white bg-opacity-10 rounded-4 myshadow d-flex flex-column"
    >
      ...
      <div class="register col-8 mx-auto text-white roboto-regular my-4 text-center">
