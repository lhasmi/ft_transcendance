    ...
    >
      ...
      <hr class="splitter col-12 mx-auto m-0 mb-2" />
			<form class="col-9 col-md-8 mx-auto">
				...
				>
					<input v-model="username" autocomplete="off" type="text" id="username" :placeholder="getText('username', store.lang)" required/>
				...
				<div
					class="input-container mt-4 mb-2 d-flex justify-content-around align-items-center"
				>
					<input v-model="email" autocomplete="off" type="email" id="email" :placeholder="getText('email', store.lang)" required/>
					<span
				...
				<div
					class="input-container mt-4 mb-2 d-flex justify-content-around align-items-center"
				>
					<input v-model="password" autocomplete="off" type="password" id="password" :placeholder="getText('password', store.lang)" required/>
					<span class="icon material-symbols-outlined" style="font-size: 24px; color: white">
						lock
					</span>
				</div>
				...
				>
					<input v-model="password2" autocomplete="off" type="password" id="password2" :placeholder="getText('password', store.lang)" required/>
					<span class="icon material-symbols-outlined" style="font-size: 24px; color: white">
						lock
					</span>
				</div>
